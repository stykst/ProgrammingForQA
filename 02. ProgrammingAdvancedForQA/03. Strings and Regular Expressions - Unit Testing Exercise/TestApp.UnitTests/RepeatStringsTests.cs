...
public class RepeatStringsTests
{
    ...
    {
        // Arrange
        string[] input = { "Test", "which", "representing" };
        string expected = "TestTestTestTestwhichwhichwhichwhichwhichrepresentingrepresentingrepresentingrepresentingrepresentingrepresentingrepresentingrepresentingrepresentingrepresentingrepresentingrepresenting";
